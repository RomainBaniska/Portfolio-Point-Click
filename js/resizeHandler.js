...
// POSITION DES ITEMS (4 colonnes de 3 boutons)
    ...
    setSpritePositionAndScaleINNERHOUSE(ordiRed, 0.096, 0.666, 770, 790);
    ...
    // Position Coffre Ouvert (rectangle invisible)
    setSpritePositionAndScaleINNERHOUSE(chestOpenRect, 0.32, 0.315, 1250, 1250);

    // Position Disquette
    setSpritePositionAndScaleINNERHOUSE(disquette, 0.534, 0.875, 2000, 2000);

    // Position DisquetteFloat
    setSpritePositionAndScaleINNERHOUSE(disquetteFloat, 0.534, 0.875, 2000, 2000);
