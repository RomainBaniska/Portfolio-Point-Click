...
// POSITION DES ITEMS (4 colonnes de 3 boutons)
    ...
    // Position qui boit
    setMovingSpriteScale(guybrushD, 830, 1185);
    ...
    setSpritePositionAndScaleINNERHOUSE(coffeMachine, 0.25, 0.666, 770, 3790);
